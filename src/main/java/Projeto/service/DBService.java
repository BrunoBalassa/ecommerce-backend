...
private BCryptPasswordEncoder pe;
    public void instantiateTestDatabase() throws ParseException {
        ...
        Cliente cli1 = new Cliente(null, "Maria Silva", "bno.balassc@gmail.com", "36378912377", TipoCliente.PESSOAFISICA,pe.encode("123"));
        cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

        Cliente cli3 = new Cliente(null, "Ana Costa", "bno.balassa@gmail.com", "36378912377", TipoCliente.PESSOAFISICA,pe.encode("123"));
        cli3.addPerfil(Perfil.ADMIN);
        cli3.getTelefones().addAll(Arrays.asList("15165151651", "2193838393"));

        Cliente cli2 = new Cliente(null, "Ana Costa", "hehehe.balassa@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
        ...
        Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "281777012", cli3, c2);
